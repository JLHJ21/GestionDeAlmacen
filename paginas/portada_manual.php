      ...
      <div class="p-4 py-0 bg-light rounded-3 pb-0 mb-0">
        <div class="container-fluid py-5">
          ...
          <div class="d-grid d-md-block text-center">
            <a href="https://github.com/SoftwareCRM/Software-CRM-Libre-y-Gratuito-" target="_blank"><button class="btn btn-info col-6" type="button">Descargar</button></a>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <div class="h-100 p-5 bg-dark rounded-3">
            ...
            <div class="d-grid d-md-block">
              <a href="../manual_de_usuario.pdf" target="_blank"><button class="btn btn-info col-6" type="button">Manual de Usuario</button></a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="h-100 p-5 bg-light border rounded-3">
            ...
            <p>Esta herramienta cuenta con un video-tutorial para una mayor accesibilidad hacia los usuarios, donde se explica de forma por encima las funciones del sistema.</p>
            <div class="d-grid d-md-block">
              <a href="https://www.youtube.com/watch?v=-dcmVtjY97Y" target="_blank"><button class="btn btn-info col-6" type="button">Tutoriales</button></a>
            </div>
          </div>
        </div>
      </div>

                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" placeholder="Ej: Empresa Josue S.A" type="text" name="tit_negocio" onkeypress="return SoloLetras(event);" onpaste="return false" minlength="3" maxlength="40" required>
                          <div class="invalid-tooltip">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" type="text" name="id_negocio" onkeypress="return RIF(event);" placeholder="Ej: J-00000000-0" onpaste="return false" minlength="9" maxlength="10" required>
                          <div class="invalid-tooltip">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" placeholder="Ej: San Manuel de Jasis" type="text" name="dir_negocio" onkeypress="return Direccion(event);" onpaste="return false" minlength="3" maxlength="50" required>
                          <div class="invalid-tooltip">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" placeholder="Ej: 0000-0000000" type="text" name="num_negocio" onkeypress="return Telefono(event);" onpaste="return false" minlength="3" maxlength="12" required>
                          <div class="invalid-tooltip">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" placeholder="Ej: Gracias por la compra ¡Feliz día!" type="text" name="pie_negocio" onkeypress="return Pie(event);" onpaste="return false" minlength="3" maxlength="40" required>
                          <div class="invalid-tooltip">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 position-relative"> 
                          <input class="p-1 form-control form-control-sm" placeholder="IVA actual: <?php echo $iva_ ?>%" type="text" name="iva"  onkeypress="return SoloNumeros(event);" onpaste="return false"  minlength="1" maxlength="3" required>
                          <div class="invalid-tooltip">

        ...
        <div> 
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <input class="form-control form-control-sm" type="text" id="ced_cliente" name="ced_cliente" placeholder="Ej: 00.000.000" onkeypress="return SoloNumeros(event)" onpaste="return false"  minlength="6" maxlength="10" required> <!-- ENVIAR INFORMACION -->
                    <div class="invalid-tooltip">
